...
class GAT_GCN(torch.nn.Module):
    def __init__(self, in_dim,n_heads,dropout,num_classes,):
        ...
        # self.conv0 = GAT(in_dim, 8, n_heads,dropout, alpha = 0.2, concat = True).cuda() 
        # self.conv1 = GAT(8, 16, n_heads,dropout, alpha = 0.2, concat = True).cuda() 
        # self.conv2 = GAT(16, 32, n_heads,dropout, alpha = 0.2, concat = True).cuda() 
        # self.conv0 = GCNConv(3, 16)
        # self.conv1 = GCNConv(8, 16)
        self.conv1 = GAT(3, 16, n_heads,dropout, alpha = 0.2, concat = True).cuda() 
        self.conv2 = GCNConv(16, 32)
        self.conv3 = GAT(32, 64, n_heads,dropout, alpha = 0.2, concat = True).cuda() 
...
if __name__=="__main__":
    ...
    # 训练记录
    # 训练记录
    # GACC GCAC GCCA GAAA GA GAA GAAAA
    # 3-16-32-64 .. .. .. 3-64 3-6 3-32-64 3-8-16-32-64  
    ...
    # adj_size=21
    epoch=300
    datapath='../Pointnet2/data/hand5000_change'
    datapath_val='../Pointnet2/data/hand5000_val_change'
    txt_path='./run/hand5000_change'
    edge_index= [[1, 2, 3, 4, 5, 22, 5, 6, 7, 8,22,21, 9, 9,  10, 11, 12, 21, 20, 13, 13, 14, 15, 16, 20, 17, 17, 18, 19],
                 [0, 1, 2, 0, 4,  4, 22,5, 6, 0, 8, 8, 22,21, 9,  10, 0,  12, 12, 20, 21, 13, 14,  0, 16, 16, 20, 17, 18]]
